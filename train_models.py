...
if __name__ == '__main__':
    ...
    attacker.train_attackers(victim_exp3, "exp3", 0.99)
    attacker.train_attackers(victim_exp3, "exp3", 1)
    attacker.train_attackers(victim_ucb, "ucb", 0.99)
    attacker.train_attackers(victim_ucb, "ucb", 1)